...
var React3DInstance = (_temp = _class = function () {
  ...
  _createClass(React3DInstance, [{
      ...
      if (process.env.NODE_ENV !== 'production' || process.env.ENABLE_REACT_ADDON_HOOKS === 'true') {
        if (this._highlightObjectId !== null) {
          ...
          if (!this._parameters.renderOnlyRenderer) {
            var _autoClear = this._renderer.autoClear;
    ...
    key: 'updateCreateRenderer',
    value: function updateCreateRenderer(createRenderer) {
    ...
    value: function refreshRenderer() {
      ...
      var contextLossExtension = !this._parameters.renderOnlyRenderer && this._renderer.extensions.get('WEBGL_lose_context');
  ...
  this._render = function () {
    ...
    if (mainCamera) {
      if (_this3._lastRenderMode !== 'camera') {
        if (!_this3._parameters.renderOnlyRenderer) {
